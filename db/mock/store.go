...
// Source: github.com/ProstoyVadila/simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) DeleteEntriesByAccount(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntriesByAccount(arg0 context.Context, arg1 uuid.UUID) ([]db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfersByFromAccount(arg0 context.Context, arg1 uuid.UUID) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfersByToAccount(arg0 context.Context, arg1 uuid.UUID) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
// GetTrasfer mocks base method.
func (m *MockStore) GetTrasfer(arg0 context.Context, arg1 uuid.UUID) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTrasfer", arg0, arg1)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTrasfer indicates an expected call of GetTrasfer.
func (mr *MockStoreMockRecorder) GetTrasfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTrasfer", reflect.TypeOf((*MockStore)(nil).GetTrasfer), arg0, arg1)
}
